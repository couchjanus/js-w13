...
function buttonClick(e) {
  console.log('Button clicked'); // document.getElementById('hell').textContent = 'Changed';
...
var button = document.getElementById('button'); // var box = document.getElementById('box');
